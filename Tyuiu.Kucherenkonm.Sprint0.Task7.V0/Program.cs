using Tyuiu.Kucherenkonm.Sprint0.Task7.V0.Lib;
Console.Title = "Спринт #0 | Выполнила: Кучеренко Н. М. | ИИПб - 25 - 1";
Console.WriteLine("********************************************************************");
...
{
    Console.WriteLine("Ошибка! Исходные массивы имеют разную длину");
}
Console.ReadKey();